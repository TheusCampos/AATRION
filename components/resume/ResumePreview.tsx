...
export function ResumePreview({ content, templateId = 'classic', style = DEFAULT_STYLE, fullscreen = false }: Props) {
  ...
  const containerStyle = fullscreen
    ? { fontFamily, fontSize, lineHeight, letterSpacing, color: '#1e293b', minHeight: '297mm' }
    : { fontFamily, fontSize, lineHeight, letterSpacing, color: '#1e293b', aspectRatio: '210/297' };
